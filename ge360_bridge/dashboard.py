...
def dashboard_page(error:str="")->str:
    ...
    body=f"""<div class='w'><div class='top'><div><h1>GE360 Universal Bridge</h1><div class='m'>FASE 10 · Resource Launcher</div></div><span class='pill mono'>{esc(s['bridge']['public_endpoint'])}</span></div>{banner}
<div class='grid'><div class='card'><div class='n'>{c['online_devices']}/{c['devices']}</div><div class='m'>device online</div></div><div class='card'><div class='n'>{c['healthy_services']}/{c['services']}</div><div class='m'>Resource ONLINE</div></div><div class='card'><div class='n'>{c.get('degraded_services',0)}</div><div class='m'>Resource DEGRADED</div></div><div class='card'><div class='n'>v0.12</div><div class='m'>Resource Launcher</div></div></div>
...
class Handler(BaseHTTPRequestHandler):
    server_version="GE360BridgeDashboard/0.12"
